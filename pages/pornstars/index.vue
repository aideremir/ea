    ...
    <div class="browse form-dark-theme">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="browse__head">
                        <h1 class="browse__title">652 Pornstars match your criteria</h1>
                        <div class="browse__filter">
                            <div class="form-check browse__filter-item">
                                ...
                                <label tabindex="0" class="form-check-label" for="showTrans">
                                    Show Trans
                                </label>
                            </div>
                            ...
                            <div class="form-check browse__filter-item">
                                ...
                                <label tabindex="0" class="form-check-label" for="showBisexual">
                                    Show Bisexual
                                </label>
                            </div>
                                    ...
                                    <div class="col-12">
                                        <div class="relative">
                                            <popper trigger="click" :options="{placement: 'bottom-start'}">
                                                <app-button slot="reference" class="browse__select" child-class="form-control form-control--small form-control-select">All Pornstars</app-button>
        ...
        <div class="container">
            ...
            <ul class="row browse__result">
                <content-item-person v-for="person in performers"
                                     :key="person.id"

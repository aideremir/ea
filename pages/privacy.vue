<template>
    ...
    <article-block title="Privacy Policy">Last revised on 28 May, 2018

Gamma Entertainment Inc. provides certain services of evilangel and shall be known as "We", "Us" and "Our". We understand the privacy of evilangel Users is very important. During the navigation of the website and the registration process Users may provide personal identifiable information about themselves, therefore We have developed this policy to protect User privacy while they enjoy evilangel.
...
What is collected
By navigating the site, signing up or communicating with the Our Client Relations department We collect personal information provided such as name, email, zip, Payment Method details, IP address and login details (username and password).

If Users choose to post information, messages or comments in public areas on evilangel then any information about the User will be kept on evilangel. Lastly, if Users send personal correspondence via email, ticket or chat such information will be maintained as a record of correspondence.
...
Third parties use personal information to complete transactions at Users' request, including but not limited to joining evilangel or providing Users with requested products. By consenting to the terms and conditions of evilangel and taking any action to facilitate the completion of a transaction, Users agree to the use of personal information in this manner.
...
Your Rights
Users have the right to stop receiving promotional emails from Us and may exercise this right at any time by clicking on the unsubscribe link at the bottom of any email, by visiting http://www.td3x.com/, or by contacting Our Client Relations department. Users may NOT opt out of receiving emails regarding account details such as responses to questions or membership purchase receipts. Users must directly contact Our partners or third parties from which they receive other communication for questions or to unsubscribe.

Users have the right to withdraw their consent to processing the personal information necessary to provide access to evilangel (such as debiting their payment method, streaming or downloading video and images, interacting with the website as a member). Users must contact Client Relations by telephone, email or chat to withdraw this consent. Please note this will remove all access to evilangel.
...
Firefox
Opera
Please remember disabling or refusing cookies may lead to many services on evilangel being unavailable

Web Beacons
In order to effectively deliver email communications and perform website analysis We may use web beacons. Web beacons are electronic files which count the Users who access evilangel or a specific page and can help Us identify if a cookie has been activated. Web beacons also allow Us to confirm that an email message was successfully delivered and read. It is not possible to decline web beacons however by refusing cookies this can also prevent web beacons from being used.
...
User login information must be protected by the User. We advise all Users NOT to share username or password details with anyone. It is the User's responsibility to keep password information confidential. A User's account may be deactivated for abuse if We assess a User's login details have been used by someone other than the registered User to evilangel.

Legal
Personal information collected on and/or through evilangel is stored and processed in Canada, the Netherlands or the United States. By using evilangel Users consent to any transfer of such information outside the country in which they reside or access evilangel and to be bound by the laws of Canada or the United States - where personal information may be stored.
...
<script>
    ...
    export default {
        ...
        head() {
            return {
                title: 'Privacy Policy | Evil Angel'
            }
        }
    }
</script>
